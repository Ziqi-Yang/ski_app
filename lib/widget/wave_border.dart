...
class WaveBorder extends StatefulWidget {
  ...
  final List<BoxShadow> boxShadow; // 貌似没用？

  const WaveBorder({Key? key,  this.count = 3,
    required this.width,
    required this.maxWidth,
    this.borderColor = Colors.blue,
    this.borderWidth = 1,
    this.duration = const Duration(milliseconds: 4000),
    this.boxShadow = const [], required this.child}) : super(key: key);

  @override
  State<WaveBorder> createState() => _WaveBorderState();
}
